...
var excludedPaths = []string{
	...
	//
	// These naming inconsistencies may indicate the presence of specialized test infrastructure
	// beyond standard harnesses or different setup contracts patterns.

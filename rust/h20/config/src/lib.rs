...
impl H20Config {
    ...
    /// Returns true if H20 is configured.
    pub const fn is_enabled(self) -> bool {
        self.activation_time.is_some()
    }

    /// Returns true if H20 is active at `timestamp`.
...
/// Invalid H20 consensus configuration.

...
//! ([`PolicyVersions::from_spec`]), and which concrete implementation backs a
...
impl PolicyVersions {
    ...
    pub fn from_spec(upgrade: H20Spec) -> Option<PolicyVersion> {
        (upgrade >= H20Spec::Beryl).then_some(PolicyVersion::V1)
    }
}

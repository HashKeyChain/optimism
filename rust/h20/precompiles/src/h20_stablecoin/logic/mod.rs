...
#[derive(Debug, Clone)]
pub struct H20StablecoinToken<S: StablecoinAccounting, A: PolicyAccounting> {
    accounting: S,
    policy: A,
...
impl<S: StablecoinAccounting, A: PolicyAccounting> Token for H20StablecoinToken<S, A> {
    type Accounting = S;

...
mod tests {
    ...
    use h20_precompile_storage::StorableType;

    use super::__packing_h20_core_storage;
    ...
    #[test]
    fn h20_core_offsets_match_mock_h20_storage() {
        assert_eq!(__packing_h20_core_storage::NAME_LOC.offset_slots, 0);
        assert_eq!(__packing_h20_core_storage::SYMBOL_LOC.offset_slots, 1);
        assert_eq!(__packing_h20_core_storage::CONTRACT_URI_LOC.offset_slots, 2);
        assert_eq!(__packing_h20_core_storage::TOTAL_SUPPLY_LOC.offset_slots, 3);
        assert_eq!(__packing_h20_core_storage::BALANCES_LOC.offset_slots, 4);
        assert_eq!(__packing_h20_core_storage::ALLOWANCES_LOC.offset_slots, 5);
        assert_eq!(__packing_h20_core_storage::ROLES_LOC.offset_slots, 6);
        assert_eq!(__packing_h20_core_storage::ROLE_ADMINS_LOC.offset_slots, 7);
        assert_eq!(__packing_h20_core_storage::ADMIN_COUNT_LOC.offset_slots, 8);
        assert_eq!(__packing_h20_core_storage::TRANSFER_SENDER_POLICY_ID_LOC.offset_slots, 9);
        assert_eq!(__packing_h20_core_storage::TRANSFER_SENDER_POLICY_ID_LOC.offset_bytes, 0);
        assert_eq!(__packing_h20_core_storage::TRANSFER_RECEIVER_POLICY_ID_LOC.offset_slots, 9);
        assert_eq!(__packing_h20_core_storage::TRANSFER_RECEIVER_POLICY_ID_LOC.offset_bytes, 8);
        assert_eq!(__packing_h20_core_storage::TRANSFER_EXECUTOR_POLICY_ID_LOC.offset_slots, 9);
        assert_eq!(__packing_h20_core_storage::TRANSFER_EXECUTOR_POLICY_ID_LOC.offset_bytes, 16);
        assert_eq!(__packing_h20_core_storage::TRANSFER_RESERVED_0_LOC.offset_slots, 9);
        assert_eq!(__packing_h20_core_storage::TRANSFER_RESERVED_0_LOC.offset_bytes, 24);
        assert_eq!(__packing_h20_core_storage::MINT_RECEIVER_POLICY_ID_LOC.offset_slots, 10);
        assert_eq!(__packing_h20_core_storage::MINT_RECEIVER_POLICY_ID_LOC.offset_bytes, 0);
        assert_eq!(__packing_h20_core_storage::PAUSED_LOC.offset_slots, 11);
        assert_eq!(__packing_h20_core_storage::SUPPLY_CAP_LOC.offset_slots, 12);
        assert_eq!(__packing_h20_core_storage::NONCES_LOC.offset_slots, 13);
    }
}

...
use hsk_h20_config::{H20Config, H20ConfigError};
...
impl<'a> arbitrary::Arbitrary<'a> for RollupConfig {
    fn arbitrary(u: &mut arbitrary::Unstructured<'a>) -> arbitrary::Result<Self> {
        ...
        let (h20_time, h20_activation_admin) = if bool::arbitrary(u)? {
...
mod tests {
    ...
    #[cfg(feature = "revm")]
    #[test]
    fn h20_config_is_independent_from_op_hardfork_selection() {
        ...
        let h20 = config.h20_config().unwrap();
    ...
    #[test]
    fn incomplete_h20_boot_config_is_rejected() {
    ...
    #[cfg(feature = "serde")]
    #[test]
    fn h20_boot_config_round_trips_in_rollup_json() {
        let config = RollupConfig {
            h20_time: Some(100),

...
use b20_precompile_macros::contract;
use b20_precompile_storage::{Handler, Mapping, StorageCtx, StorageKey, setup_storage};
...
mod mapping_only_storable_layout {
    ...
    use b20_precompile_macros::Storable;
    use b20_precompile_storage::{Mapping, StorableType};
...
mod namespaced_layout {
    ...
    use b20_precompile_macros::{Storable, contract};
    use b20_precompile_storage::{Handler, Mapping, StorageCtx, StorageKey, setup_storage};
...
mod struct_level_attribute_passthrough {
    ...
    mod allow_and_doc {
        use alloy_primitives::{Address, U256, address};
        use b20_precompile_macros::contract;
        use b20_precompile_storage::{Handler, StorageCtx, setup_storage};

...
use b20_precompile_macros::{StablecoinAccounting, Storable, TokenAccounting, contract};
use b20_precompile_storage::{BasePrecompileError, Handler, Result, StorageCtx};
...
mod tests {
    ...
    use b20_precompile_storage::{Handler, StorableType, StorageCtx, setup_storage};

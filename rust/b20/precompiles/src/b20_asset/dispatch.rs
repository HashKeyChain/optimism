...
use b20_precompile_storage::{BasePrecompileError, StorageCtx};
...
mod tests {
    ...
    use b20_precompile_storage::{HashMapStorageProvider, Result, StorageCtx};
    ...
    const UPGRADE: B20Spec = B20Spec::Beryl;
    ...
    fn announce_inner_system_error_propagates_unchanged() {
        ...
        assert_eq!(err, b20_precompile_storage::BasePrecompileError::under_overflow());
    }
    ...
    fn announce_inner_ordinary_revert_wraps_as_internal_call_failed() {
        ...
        assert_eq!(
            err,
            b20_precompile_storage::BasePrecompileError::revert(IB20Asset::InternalCallFailed {
                call: inner_call
            })
        );
    }

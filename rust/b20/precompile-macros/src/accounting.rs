...
fn expand_token(input: DeriveInput) -> syn::Result<TokenStream> {
    ...
    let decimals_impl = if has_asset {
        ...
        quote! {
            Ok(crate::B20Variant::from_address(
                ::b20_precompile_storage::ContractStorage::address(self),
            )
    ...
    Ok(quote! {
        impl #name<'_> {
            ...
            ) -> ::b20_precompile_storage::Result<crate::B20PolicyType> {
                crate::B20PolicyType::from_id(policy_scope).ok_or_else(|| {
                    ::b20_precompile_storage::BasePrecompileError::revert(
        ...
        impl crate::TokenAccounting for #name<'_> {
            ...
            fn is_initialized(&self) -> ::b20_precompile_storage::Result<bool> {
                ::b20_precompile_storage::ContractStorage::is_initialized(self)
            }

            fn balance_of(
                &self,
                account: ::alloy_primitives::Address,
            ) -> ::b20_precompile_storage::Result<::alloy_primitives::U256> {
            ...
            fn supply_cap(&self) -> ::b20_precompile_storage::Result<::alloy_primitives::U256> {
                self.b20.supply_cap()
            }
            ...
            fn name(&self) -> ::b20_precompile_storage::Result<::alloc::string::String> {
                self.b20.name()
            }
            ...
            fn symbol(&self) -> ::b20_precompile_storage::Result<::alloc::string::String> {
                self.b20.symbol()
            }
            ...
            fn decimals(&self) -> ::b20_precompile_storage::Result<u8> {
                #decimals_impl
            }

            fn paused(&self) -> ::b20_precompile_storage::Result<::alloy_primitives::U256> {
                self.b20.paused()
            }
            ...
            fn increment_nonce(
                ...
                let next = current
                    ...
                    .ok_or_else(::b20_precompile_storage::BasePrecompileError::under_overflow)?;
                self.b20.set_nonce(owner, next)
            }

            fn contract_uri(&self) -> ::b20_precompile_storage::Result<::alloc::string::String> {
            ...
            fn has_role(
                ...
                account: ::alloy_primitives::Address,
            ) -> ::b20_precompile_storage::Result<bool> {
            ...
            fn role_admin(
                &self,
                role: ::alloy_primitives::B256,
            ) -> ::b20_precompile_storage::Result<::alloy_primitives::B256> {
            ...
            fn policy_id(
                &self,
                policy_scope: ::alloy_primitives::B256,
            ) -> ::b20_precompile_storage::Result<u64> {
...
fn expand_stablecoin(input: DeriveInput) -> syn::Result<TokenStream> {
    ...
    Ok(quote! {
        impl crate::StablecoinAccounting for #name<'_> {
            fn currency(&self) -> ::b20_precompile_storage::Result<::alloc::string::String> {
    ...
    Ok(quote! {
        impl crate::AssetAccounting for #name<'_> {
            ...
            fn extra_metadata(
                &self,
                key: &str,
            ) -> ::b20_precompile_storage::Result<::alloc::string::String> {
                ::b20_precompile_storage::Handler::read(
                    self.asset
                        .extra_metadata
            ...
            fn set_extra_metadata_value(
                ...
                if value.is_empty() {
                    ::b20_precompile_storage::Handler::delete(self.asset.extra_metadata.at_mut(&key))
                } else {
                    ::b20_precompile_storage::Handler::write(
